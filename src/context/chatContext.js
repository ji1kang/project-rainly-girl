...
const ChatContextProvider = (props) => {
  const [messages, addMessage, clearMessages, chatCount, addChatCount, clearChatCount] = useMessageCollection([]);

  return (
    <ChatContext.Provider value={[messages, addMessage, clearMessages, chatCount, addChatCount, clearChatCount]}>
      {props.children}
